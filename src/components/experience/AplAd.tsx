...
const AplAd = () => {
  return (
    <div className={container}>
      <CompanyInfo companyName={'아인플래닛'} companyRole={'Frontend Developer'} period={'2019.08 - 2020.06'} url={'https://www.youtube.com/watch?v=0BhrT0JuubE'} />
      <div className={content}>
        <div className={projectWrap}>
          <h4 className={project}>에디프레소 2.0</h4>
        ...
        <div className={projectWrap}>
          <h4 className={project}>공감신문, 내외경제, 리서치페이퍼 페이지 개발</h4>
